  ...
  return (
    <>
      <div className="w-full h-[100vh] flex items-center justify-center bg-black">
        ...
        />
        <form className="w-[25%] h-[65%]   backdrop-blur  flex flex-col items-center justify-center gap-[30px] z-200 p-5 rounded-[30px] border-2 border-white">
          ...
          <div className="gap-[20px] flex flex-col items-center justify-center">
            ...
            <div className="relative w-full h-[50px] bg-transparent text-white rounded-full text-[18px]">
              <FaLock
                className="absolute left-[20px] top-1/2 transform -translate-y-1/2 text-gray-300 pointer-events-none"
              ...
              />
              {!setShowPassword &&
                <FaEye className="absolute right-[20px] top-1/2 transform -translate-y-1/2 text-gray-300 cursor-pointer" />
              }
            </div>
